...
/**
 * Fluent helper to create a new {@link vdm.namespaces.odataserviceforbusinesspartner.AddressHomePageURL AddressHomePageURL} entity and save it to the S/4HANA system.<p>
    ...
    extends FluentHelperCreate<AddressHomePageURLCreateFluentHelper, AddressHomePageURL>
{
    ...
    /**
     * Creates a fluent helper object that will create a {@link vdm.namespaces.odataserviceforbusinesspartner.AddressHomePageURL AddressHomePageURL} entity on the OData endpoint. To perform execution, call the {@link #execute execute} method on the fluent helper object.
     * 
     * @param servicePath
