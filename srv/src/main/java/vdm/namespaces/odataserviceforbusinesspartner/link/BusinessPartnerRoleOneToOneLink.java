...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.odataserviceforbusinesspartner.BusinessPartnerRole BusinessPartnerRole} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.odataserviceforbusinesspartner.link.BusinessPartnerRoleLink BusinessPartnerRoleLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BusinessPartnerRoleOneToOneLink<ObjectT extends VdmObject<?> >
    extends BusinessPartnerRoleLink<ObjectT>
    implements OneToOneLink<BusinessPartnerRole, ObjectT>
{
     ...
     */
    public BusinessPartnerRoleOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BusinessPartnerRole> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<BusinessPartnerRole>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
