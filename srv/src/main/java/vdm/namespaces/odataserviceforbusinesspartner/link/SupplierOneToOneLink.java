...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.odataserviceforbusinesspartner.Supplier Supplier} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.odataserviceforbusinesspartner.link.SupplierLink SupplierLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class SupplierOneToOneLink<ObjectT extends VdmObject<?> >
    extends SupplierLink<ObjectT>
    implements OneToOneLink<Supplier, ObjectT>
{
     ...
     */
    public SupplierOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<Supplier> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<Supplier>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
