...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.odataserviceforbusinesspartner.CustomerSalesAreaTax CustomerSalesAreaTax} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.odataserviceforbusinesspartner.link.CustomerSalesAreaTaxLink CustomerSalesAreaTaxLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class CustomerSalesAreaTaxOneToOneLink<ObjectT extends VdmObject<?> >
    extends CustomerSalesAreaTaxLink<ObjectT>
    implements OneToOneLink<CustomerSalesAreaTax, ObjectT>
{
     ...
     */
    public CustomerSalesAreaTaxOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<CustomerSalesAreaTax> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<CustomerSalesAreaTax>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
