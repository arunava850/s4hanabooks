...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.odataserviceforbusinesspartner.CustomerSalesArea CustomerSalesArea} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.odataserviceforbusinesspartner.link.CustomerSalesAreaLink CustomerSalesAreaLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class CustomerSalesAreaOneToOneLink<ObjectT extends VdmObject<?> >
    extends CustomerSalesAreaLink<ObjectT>
    implements OneToOneLink<CustomerSalesArea, ObjectT>
{
     ...
     */
    public CustomerSalesAreaOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<CustomerSalesArea> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<CustomerSalesArea>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
