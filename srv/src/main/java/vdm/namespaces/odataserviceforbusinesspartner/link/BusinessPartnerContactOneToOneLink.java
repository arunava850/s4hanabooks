...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.odataserviceforbusinesspartner.BusinessPartnerContact BusinessPartnerContact} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.odataserviceforbusinesspartner.link.BusinessPartnerContactLink BusinessPartnerContactLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BusinessPartnerContactOneToOneLink<ObjectT extends VdmObject<?> >
    extends BusinessPartnerContactLink<ObjectT>
    implements OneToOneLink<BusinessPartnerContact, ObjectT>
{
     ...
     */
    public BusinessPartnerContactOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BusinessPartnerContact> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<BusinessPartnerContact>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
