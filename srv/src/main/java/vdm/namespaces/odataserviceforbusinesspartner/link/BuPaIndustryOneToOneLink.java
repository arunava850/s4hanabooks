...
/**
 * Template class to represent entity navigation links of {@link vdm.namespaces.odataserviceforbusinesspartner.BuPaIndustry BuPaIndustry} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link vdm.namespaces.odataserviceforbusinesspartner.link.BuPaIndustryLink BuPaIndustryLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class BuPaIndustryOneToOneLink<ObjectT extends VdmObject<?> >
    extends BuPaIndustryLink<ObjectT>
    implements OneToOneLink<BuPaIndustry, ObjectT>
{
     ...
     */
    public BuPaIndustryOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<BuPaIndustry> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<BuPaIndustry>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
