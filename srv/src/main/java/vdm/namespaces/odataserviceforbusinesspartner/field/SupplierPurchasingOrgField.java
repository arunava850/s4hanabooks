...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.SupplierPurchasingOrg SupplierPurchasingOrg}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class SupplierPurchasingOrgField<FieldT >
    extends EntityField<SupplierPurchasingOrg, FieldT>
    implements SupplierPurchasingOrgSelectable
{
     ...
     */
    public SupplierPurchasingOrgField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public SupplierPurchasingOrgField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
