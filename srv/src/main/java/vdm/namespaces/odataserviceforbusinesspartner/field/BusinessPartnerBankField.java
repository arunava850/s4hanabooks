...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.BusinessPartnerBank BusinessPartnerBank}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BusinessPartnerBankField<FieldT >
    extends EntityField<BusinessPartnerBank, FieldT>
    implements BusinessPartnerBankSelectable
{
     ...
     */
    public BusinessPartnerBankField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public BusinessPartnerBankField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
