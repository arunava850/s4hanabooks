...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.BusinessPartnerContact BusinessPartnerContact}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BusinessPartnerContactField<FieldT >
    extends EntityField<BusinessPartnerContact, FieldT>
    implements BusinessPartnerContactSelectable
{
     ...
     */
    public BusinessPartnerContactField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public BusinessPartnerContactField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
