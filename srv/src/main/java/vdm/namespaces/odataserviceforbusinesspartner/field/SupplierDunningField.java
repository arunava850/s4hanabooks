...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.SupplierDunning SupplierDunning}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class SupplierDunningField<FieldT >
    extends EntityField<SupplierDunning, FieldT>
    implements SupplierDunningSelectable
{
     ...
     */
    public SupplierDunningField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public SupplierDunningField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
