...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.AddressPhoneNumber AddressPhoneNumber}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class AddressPhoneNumberField<FieldT >
    extends EntityField<AddressPhoneNumber, FieldT>
    implements AddressPhoneNumberSelectable
{
     ...
     */
    public AddressPhoneNumberField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public AddressPhoneNumberField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
