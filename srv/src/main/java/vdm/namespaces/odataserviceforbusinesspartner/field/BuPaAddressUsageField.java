...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.BuPaAddressUsage BuPaAddressUsage}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BuPaAddressUsageField<FieldT >
    extends EntityField<BuPaAddressUsage, FieldT>
    implements BuPaAddressUsageSelectable
{
     ...
     */
    public BuPaAddressUsageField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public BuPaAddressUsageField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
