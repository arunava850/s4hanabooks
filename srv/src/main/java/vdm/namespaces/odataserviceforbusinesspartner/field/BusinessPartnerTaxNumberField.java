...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.BusinessPartnerTaxNumber BusinessPartnerTaxNumber}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BusinessPartnerTaxNumberField<FieldT >
    extends EntityField<BusinessPartnerTaxNumber, FieldT>
    implements BusinessPartnerTaxNumberSelectable
{
     ...
     */
    public BusinessPartnerTaxNumberField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public BusinessPartnerTaxNumberField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
