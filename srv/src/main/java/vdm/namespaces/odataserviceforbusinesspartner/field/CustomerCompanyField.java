...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.CustomerCompany CustomerCompany}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CustomerCompanyField<FieldT >
    extends EntityField<CustomerCompany, FieldT>
    implements CustomerCompanySelectable
{
     ...
     */
    public CustomerCompanyField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public CustomerCompanyField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
