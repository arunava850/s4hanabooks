...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.Customer Customer}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CustomerField<FieldT >
    extends EntityField<Customer, FieldT>
    implements CustomerSelectable
{
     ...
     */
    public CustomerField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
