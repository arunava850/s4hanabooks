...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.CustomerSalesAreaTax CustomerSalesAreaTax}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CustomerSalesAreaTaxField<FieldT >
    extends EntityField<CustomerSalesAreaTax, FieldT>
    implements CustomerSalesAreaTaxSelectable
{
     ...
     */
    public CustomerSalesAreaTaxField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public CustomerSalesAreaTaxField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
