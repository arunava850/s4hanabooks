...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.AddressEmailAddress AddressEmailAddress}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class AddressEmailAddressField<FieldT >
    extends EntityField<AddressEmailAddress, FieldT>
    implements AddressEmailAddressSelectable
{
     ...
     */
    public AddressEmailAddressField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public AddressEmailAddressField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
