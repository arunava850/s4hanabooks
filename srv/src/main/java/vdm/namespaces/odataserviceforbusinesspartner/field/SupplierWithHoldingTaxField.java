...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.SupplierWithHoldingTax SupplierWithHoldingTax}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class SupplierWithHoldingTaxField<FieldT >
    extends EntityField<SupplierWithHoldingTax, FieldT>
    implements SupplierWithHoldingTaxSelectable
{
     ...
     */
    public SupplierWithHoldingTaxField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public SupplierWithHoldingTaxField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
