...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.SupplierCompany SupplierCompany}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class SupplierCompanyField<FieldT >
    extends EntityField<SupplierCompany, FieldT>
    implements SupplierCompanySelectable
{
     ...
     */
    public SupplierCompanyField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public SupplierCompanyField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
