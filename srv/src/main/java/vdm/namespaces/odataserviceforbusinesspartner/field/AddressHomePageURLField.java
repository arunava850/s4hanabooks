...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.AddressHomePageURL AddressHomePageURL}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class AddressHomePageURLField<FieldT >
    extends EntityField<AddressHomePageURL, FieldT>
    implements AddressHomePageURLSelectable
{
     ...
     */
    public AddressHomePageURLField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public AddressHomePageURLField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
