...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.Supplier Supplier}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class SupplierField<FieldT >
    extends EntityField<Supplier, FieldT>
    implements SupplierSelectable
{
     ...
     */
    public SupplierField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public SupplierField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
