...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.BuPaIdentification BuPaIdentification}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BuPaIdentificationField<FieldT >
    extends EntityField<BuPaIdentification, FieldT>
    implements BuPaIdentificationSelectable
{
     ...
     */
    public BuPaIdentificationField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public BuPaIdentificationField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
