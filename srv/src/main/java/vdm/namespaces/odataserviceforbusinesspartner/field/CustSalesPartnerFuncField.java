...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.CustSalesPartnerFunc CustSalesPartnerFunc}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CustSalesPartnerFuncField<FieldT >
    extends EntityField<CustSalesPartnerFunc, FieldT>
    implements CustSalesPartnerFuncSelectable
{
     ...
     */
    public CustSalesPartnerFuncField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public CustSalesPartnerFuncField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
