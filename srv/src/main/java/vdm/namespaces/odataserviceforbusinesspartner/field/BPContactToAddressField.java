...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.BPContactToAddress BPContactToAddress}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BPContactToAddressField<FieldT >
    extends EntityField<BPContactToAddress, FieldT>
    implements BPContactToAddressSelectable
{
     ...
     */
    public BPContactToAddressField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public BPContactToAddressField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
