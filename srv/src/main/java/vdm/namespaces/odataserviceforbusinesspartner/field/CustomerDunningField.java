...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.CustomerDunning CustomerDunning}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CustomerDunningField<FieldT >
    extends EntityField<CustomerDunning, FieldT>
    implements CustomerDunningSelectable
{
     ...
     */
    public CustomerDunningField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public CustomerDunningField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
