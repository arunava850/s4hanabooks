...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.CustomerWithHoldingTax CustomerWithHoldingTax}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CustomerWithHoldingTaxField<FieldT >
    extends EntityField<CustomerWithHoldingTax, FieldT>
    implements CustomerWithHoldingTaxSelectable
{
     ...
     */
    public CustomerWithHoldingTaxField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public CustomerWithHoldingTaxField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
