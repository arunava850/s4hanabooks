...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.SupplierPartnerFunc SupplierPartnerFunc}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class SupplierPartnerFuncField<FieldT >
    extends EntityField<SupplierPartnerFunc, FieldT>
    implements SupplierPartnerFuncSelectable
{
     ...
     */
    public SupplierPartnerFuncField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public SupplierPartnerFuncField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
