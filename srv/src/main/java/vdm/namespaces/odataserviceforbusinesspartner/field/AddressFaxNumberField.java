...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.AddressFaxNumber AddressFaxNumber}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class AddressFaxNumberField<FieldT >
    extends EntityField<AddressFaxNumber, FieldT>
    implements AddressFaxNumberSelectable
{
     ...
     */
    public AddressFaxNumberField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public AddressFaxNumberField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
