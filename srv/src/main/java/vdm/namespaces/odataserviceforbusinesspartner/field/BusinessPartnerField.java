...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.BusinessPartner BusinessPartner}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BusinessPartnerField<FieldT >
    extends EntityField<BusinessPartner, FieldT>
    implements BusinessPartnerSelectable
{
     ...
     */
    public BusinessPartnerField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public BusinessPartnerField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
