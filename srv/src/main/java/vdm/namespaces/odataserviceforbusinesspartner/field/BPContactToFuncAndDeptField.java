...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.BPContactToFuncAndDept BPContactToFuncAndDept}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BPContactToFuncAndDeptField<FieldT >
    extends EntityField<BPContactToFuncAndDept, FieldT>
    implements BPContactToFuncAndDeptSelectable
{
     ...
     */
    public BPContactToFuncAndDeptField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public BPContactToFuncAndDeptField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
