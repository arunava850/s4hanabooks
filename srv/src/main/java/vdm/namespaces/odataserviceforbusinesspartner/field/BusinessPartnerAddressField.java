...
/**
 * Template class to represent entity fields of the Entity {@link vdm.namespaces.odataserviceforbusinesspartner.BusinessPartnerAddress BusinessPartnerAddress}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class BusinessPartnerAddressField<FieldT >
    extends EntityField<BusinessPartnerAddress, FieldT>
    implements BusinessPartnerAddressSelectable
{
     ...
     */
    public BusinessPartnerAddressField(final String fieldName) {
        super(fieldName);
    }
     ...
     */
    public BusinessPartnerAddressField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
