...
import vdm.namespaces.odataserviceforbusinesspartner.field.BusinessPartnerAddressField;
import vdm.namespaces.odataserviceforbusinesspartner.link.BusinessPartnerAddressLink;
import vdm.namespaces.odataserviceforbusinesspartner.selectable.BusinessPartnerAddressSelectable;


/**
 * Business Partner Address<p></p><p>Original entity name from the Odata EDM: <b>A_BusinessPartnerAddressType</b></p>
 * 
 */
@Builder
@Data
    ...
    extends VdmEntity<BusinessPartnerAddress>
{
     ...
     * 
     */
    public final static BusinessPartnerAddressSelectable ALL_FIELDS = new BusinessPartnerAddressSelectable() {
        ...
        throws ODataException
    {
        ...
        odataResourceUrl.append(")/");
        odataResourceUrl.append("to_AddressUsage");
        ...
        final List<BuPaAddressUsage> entityList = result.asList(BuPaAddressUsage.class);
        for (BuPaAddressUsage entity: entityList) {
     ...
     * Retrieval of associated <b>BuPaAddressUsage</b> entities (one to many). This corresponds to the OData navigation property <b>to_AddressUsage</b>.
     * <p>
     * If the navigation property for an entity <b>BusinessPartnerAddress</b> has not been resolved yet, this method will <b>not query</b> further information. Instead its <code>Optional</code> result state will be <code>empty</code>.
     * 
     * @return
     *     If the information for navigation property <b>to_AddressUsage</b> is already loaded, the result will contain the <b>BuPaAddressUsage</b> entities. If not, an <code>Optional</code> with result state <code>empty</code> is returned.
     */
    @Nonnull
    public Optional<List<BuPaAddressUsage>> getAddressUsageIfPresent() {
        return Optional.ofNullable(toAddressUsage);
    }
    ...
    public final static class BusinessPartnerAddressBuilder {
        ...
        private BusinessPartnerAddress.BusinessPartnerAddressBuilder toAddressUsage(List<BuPaAddressUsage> value) {
            toAddressUsage.addAll(value);
            return this;
        }
        ...
        private BusinessPartnerAddress.BusinessPartnerAddressBuilder toEmailAddress(List<AddressEmailAddress> value) {
            toEmailAddress.addAll(value);
            return this;
        }
        ...
        private BusinessPartnerAddress.BusinessPartnerAddressBuilder toFaxNumber(List<AddressFaxNumber> value) {
            toFaxNumber.addAll(value);
            return this;
        }
        ...
        private BusinessPartnerAddress.BusinessPartnerAddressBuilder toMobilePhoneNumber(List<AddressPhoneNumber> value) {
            toMobilePhoneNumber.addAll(value);
            return this;
        }
        ...
        private BusinessPartnerAddress.BusinessPartnerAddressBuilder toPhoneNumber(List<AddressPhoneNumber> value) {
            toPhoneNumber.addAll(value);
            return this;
        }
        ...
        private BusinessPartnerAddress.BusinessPartnerAddressBuilder toURLAddress(List<AddressHomePageURL> value) {
            toURLAddress.addAll(value);
            return this;
        }
