...
/**
 * Fluent helper to fetch a single {@link vdm.namespaces.odataserviceforbusinesspartner.SupplierWithHoldingTax SupplierWithHoldingTax} entity using key fields. This fluent helper allows methods which modify the underlying query to be called before executing the query itself. 
 * 
 */
    ...
    extends FluentHelperByKey<SupplierWithHoldingTaxByKeyFluentHelper, SupplierWithHoldingTax, SupplierWithHoldingTaxSelectable>
{
    ...
    /**
     * Creates a fluent helper object that will fetch a single {@link vdm.namespaces.odataserviceforbusinesspartner.SupplierWithHoldingTax SupplierWithHoldingTax} entity with the provided key field values. To perform execution, call the {@link #execute execute} method on the fluent helper object.
     * 
     * @param companyCode
    ...
    public SupplierWithHoldingTaxByKeyFluentHelper(
        @Nonnull
        final String servicePath, final String supplier, final String companyCode, final String withholdingTaxType) {
        super(servicePath);
